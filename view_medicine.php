...
<div class="main-content">
    ...
    <h3 class="mb-4 text-primary">🏥 Medicine Inventory</h3>
...
<?php endif; ?>
    ...
    <table class="table table-bordered table-hover" id="medicineTable">
      ...
      <tbody>
        ...
        <tr>
          ...
          <!-- EDIT BUTTON -->
          <td>
            <a href="database/edit_medicine.php?id=<?= $row['medicine_id'] ?>"
          ...
          <td>
            <td>
           <form action="database/delete_medicine.php" method="POST"
    ...
    <!-- Navigation -->
    <div class="mt-4">
      <a href="add_new_medicine.php" class="btn btn-primary">➕ Add Medicine</a>
    </div>
  </div>

...
<head>
  ...
  <title>KWAMCHINA DISPENSARY DASHBOARD | ADMIN DASHBOARD</title>
...
<body>
  <div class="container py-4">
    <header class="d-flex justify-content-between align-items-center mb-4">
      <h3>🩺 DISPENSARY FINANCIAL MONITORING SYSTEM DASHBOARD | ADMIN DASHBOARD</h3>
      ...
      <div class="col-md-4">
        <div class="card mb-3">
          ...
          <div class="card-body d-grid gap-2">
            ...
            class="btn btn-outline-primary">➕ Manage Users 
            </a>
            
            <a href="view_payments.php"
           class="btn btn-outline-success">🧾 View Payments
          </a>
            <a href="view_medicine.php" class="btn btn-outline-warning">🏥 Manage Medicines</a>
            <a href="register.php"
            class="btn btn-outline-primary">➕ Create Users
            </a>

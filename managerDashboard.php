...
<head>
  ...
  <title>KWAMCHINA DISPENSARY DASHBOARD | MANAGER</title>
...
<body>
  <div class="container py-4">
    <header class="d-flex justify-content-between align-items-center mb-4">
      <h3>🩺 DISPENSARY FINANCIAL MONITORING SYSTEM DASHBOARD | MANAGER</h3>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body d-grid gap-2">
           ...
           class="btn btn-outline-success">🧾 View Payments
            ...
            <a href="view_medicine.php" class="btn btn-outline-warning">🏥 View Medicines</a>
            <a href="view_users.php"
            class="btn btn-outline-primary">➕ View Staff
            </a>
